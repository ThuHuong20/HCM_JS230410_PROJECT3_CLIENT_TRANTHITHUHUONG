...
export default function Info() {
    ...
    console.log("🚀 ~ file: Info.jsx:15 ~ Info ~  userStore:", userStore);
    useEffect(() => {
                ...
                >
                    ...
                    <div style={{ width: "400px" }}>
                        <input
                            ...
                            value={userStore.data.first_name}
                        />
                        <br />
                        <input
                            type="text"
                            placeholder="Last Name"
                            value={userStore.data.last_name}
                        />
                        <br />
                        <input
                            type="text"
                ...
                >
                    ...
                    >
                        ...
                        <div>
                            ...
                            >
                                <p>
                                    Please click Resend Email to send a password
                                ...
                                <button
                                    ...
                                    onClick={async (e) => {
                                        if (!userStore.data?.email_confirm) {
                                            Modal.success({
                                                content:
                                                    "Please confirm the password change email",
                                            });
                                            let result =
